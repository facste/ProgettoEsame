...
<div style="overflow-x:auto;" id="log">
    <form method="post" action="/creapat.do" id="creapat">
        <p class="form">
            <label>Nome</label> *<input type="text" class="txt" name="np" id="np"><br><br>
        </p>
        <p class="form">
            <label>CF</label> *<input type="text" class="txt" name="cf" id="cf" value="<%=request.getSession().getAttribute("cf")%>"
