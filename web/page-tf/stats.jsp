...
<form method="post" action="stats.jsp" id="form">
    <label>Data inizio</label><input type="datetime-local" name="inizio">
    <label>Data fine</label><input type="datetime-local" name="fine"><br><br>
